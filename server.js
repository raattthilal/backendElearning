...
module.exports = {
    ...
    start: function (serviceName, routes) {
        ...
        this.connectToDb(function () {
            ...
            const privateKey = fs.readFileSync('/etc/letsencrypt/live/www.letstalkenglish.co.in/privkey.pem', 'utf8');
            const certificate = fs.readFileSync('/etc/letsencrypt/live/www.letstalkenglish.co.in/fullchain.pem;', 'utf8');
            const ca = fs.readFileSync('/etc/letsencrypt/live/www.letstalkenglish.com/chain.pem', 'utf8');
